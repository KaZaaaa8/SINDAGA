...
<aside class="w-64 bg-dark-200 border-r border-dark-300 min-h-screen hidden md:block">
    <nav class="p-4">
        ...
        <div class="space-y-2">
            ...
            <!-- Surat Section in sidebar.php -->
            <div class="pt-4 mt-4 border-t border-dark-300">
                <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Surat</p>

                <a href="<?= $base_url ?>/pages/surat/index.php"
                    class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors duration-200
              <?= strpos($current_path, 'belum-memiliki-rumah.php') ? 'bg-indigo-500/10 text-indigo-400' : 'text-gray-400 hover:bg-dark-300 hover:text-white' ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                    </svg>
                    Pembuatan Surat

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE wilayah SET nama_wilayah = ?, ketua_rt = ? WHERE id = ?";
    $stmt = mysqli_prepare($koneksi, $query);
    mysqli_stmt_bind_param($stmt, "ssi", $nama_wilayah, $ketua_rt, $id);
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-base text-gray-400 mt-1">Edit data RT yang sudah ada</p>
                        </div>
                        <a href="index.php"
                ...
                <div class="bg-dark-200 rounded-xl border border-dark-300 shadow-lg">
                    <div class="border-b border-dark-300 p-8">
                        ...
                        <p class="mt-2 text-base text-gray-400">Perbarui informasi data RT</p>
                    </div>
                            ...
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <input type="text" name="nama_wilayah" required
                                        value="<?= htmlspecialchars($data['nama_wilayah']) ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ketua_rt"
                                        value="<?= htmlspecialchars($data['ketua_rt']) ?>"
                                        class="w-full rounded-lg bg-dark-100 border-dark-300 text-gray-300 
                                               text-base py-3.5 px-5 placeholder-gray-500
                                               focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"

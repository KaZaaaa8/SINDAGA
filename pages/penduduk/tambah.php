...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO penduduk (nik, id_kk, nama_lengkap, tempat_lahir, tanggal_lahir, 
              jenis_kelamin, agama, status_kawin, pekerjaan, status_keluarga) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<head>
    ...
    <title>Tambah Penduduk - SINDAGA</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <div class="max-w-5xl mx-auto">
                <!-- Page Header -->
                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-white">Tambah Penduduk</h1>
                    <p class="text-base text-gray-400 mt-1">Tambah data penduduk baru</p>
                </div>

                <!-- Form Card -->
                <div class="bg-dark-200 rounded-xl border border-dark-300 shadow-lg">
                    <div class="border-b border-dark-300 p-8">
                        <h2 class="text-2xl font-semibold text-white">Formulir Data Penduduk</h2>
                    ...
                    <form method="POST" class="p-8 space-y-12">
                        <!-- Identitas Utama -->
                        <div>
                            <h3 class="text-lg font-semibold text-indigo-400 mb-8 pb-3 border-b border-dark-300">Identitas Utama</h3>
                        ...
                        <!-- Data Pribadi -->
                        <div>
                            <h3 class="text-lg font-semibold text-indigo-400 mb-8 pb-3 border-b border-dark-300">Data Pribadi</h3>
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    <label class="block text-base font-medium text-gray-300 mb-3">
                        ...
                        <!-- Informasi Kelahiran -->
                        <div>
                            <h3 class="text-lg font-semibold text-indigo-400 mb-8 pb-3 border-b border-dark-300">Informasi Kelahiran</h3>
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    <label class="block text-base font-medium text-gray-300 mb-3">
                        ...
                        <!-- Data Tambahan -->
                        <div>
                            <h3 class="text-lg font-semibold text-indigo-400 mb-8 pb-3 border-b border-dark-300">Data Tambahan</h3>
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    <label class="block text-base font-medium text-gray-300 mb-3">
                                ...
                                <div>
                                    ...
                                    <select name="agama" required
                                        ...
                                        <?php foreach (['ISLAM', 'KRISTEN', 'KATOLIK', 'HINDU', 'BUDDHA', 'KONGHUCU'] as $agama): ?>
                                            <option value="<?= $agama ?>"><?= ucfirst(strtolower($agama)) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
               ...
               focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <!-- Status & Pekerjaan -->
                        <div>
                            <h3 class="text-lg font-semibold text-indigo-400 mb-8 pb-3 border-b border-dark-300">Status & Pekerjaan</h3>
                            <div class="grid grid-cols-2 gap-8">
                                <div>
                                    <label class="block text-base font-medium text-gray-300 mb-3">
